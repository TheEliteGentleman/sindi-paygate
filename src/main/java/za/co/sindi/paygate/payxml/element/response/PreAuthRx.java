...
@XmlType(name = "")
@XmlRootElement(name = "preauthrx")
public class PreAuthRx implements Response {
	 ...
	 * @param cardType
	 */
	public PreAuthRx(String transactionID, String accountReference, int transactionStatusCode, String transactionStatusDescription, int resultCode, String resultDescription, String riskIndicator, CardType cardType) {
		super();
