...
@XmlType(name = "")
@XmlRootElement(name = "refundrx")
public class RefundRx implements Response {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6215754414687530185L;
	 ...
	 */
	public RefundRx(String transactionId, String accountReference, int transactionStatusCode, String transactionStatusDescription, int resultCode, String resultDescription) {
		super();
